...
public class FileService {
    ...
    public FileService(BlobServiceClient blobServiceClient, FileRepository fileRepository, FolderRepository folderRepository, UserRepository userRepository, StorageService storageService, BlobStorageService blobStorageService) {
    ...
    public String uploadFile(MultipartFile file, String userId, Long folderId) {
        try {
            ...
            fileEntity.setFile_url(blobServiceClient.getBlobContainerClient(userId).getBlobClient(file.getOriginalFilename()).getBlobUrl());
...
//            storageService.updateCapacity(user.getStorage().getId(), file.getSize());
    ...
    public String deleteFile(Long fileId) {
        try {
            ...
            blobStorageService.delete(file.getUser().getId().toString(), file.getFile_name());
